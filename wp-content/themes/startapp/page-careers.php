...
<html lang="en-US">
	...
	<body>
		...
		<main>
			<div class="page-title title-size-xl text-light bg-parallax" data-parallax-speed="0.4" data-parallax-type="scroll-opacity" style="background-image: url(assets/img/fin-bg-3.jpg);">
			      ...
			      <div class="row">
			          ...
			          <div>
			            <article class="portfolio-tile">
			              ...
			              <div class="portfolio-info">
			                ...
			                <a class="btn btn-sm btn-primary btn-ghost" href="portfolio-single.html">View Project</a>
			              </div>
			            </article>
			          </div>
			        </div>
			        ...
			        <div class="col-sm-8">
			          <div class="custom-links">
			            <ul>
			              <li>
			                <span>Buenos Aires, AR</span><a href="#">Technical Recruiter</a>
			              </li>

			              <li>
			                <span>Palo Alto, CA, US</span><a href="#">Network Engineer</a>
			              </li>

			              <li>
			                <span>Palo Alto, CA, US</span><a href="#">Software Development Engineer in Test (SDET)</a>
			              </li>

			              <li>
			                <span>Palo Alto, CA, US</span><a href="#">Sr. Software Engineer (Cloud Development)</a>
			              </li>
			            </ul>
			          </div>
			        </div>
