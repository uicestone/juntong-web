			...
			<div class="container">
				<div class="text-block">
					<h2>
						...
						market value of over $1.4 trillion. Meet our main Offices.
					</h2>
				</div>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="contacts-tile">
							...
							<div class="google-map" data-address="1125 Merrill Street, Menlo Park, CA 94025, USA"
					...
					<div class="col-sm-4">
						<div class="contacts-tile">
							...
							<div class="google-map" data-address="44 West 28th Street 8th Floor, New York, NY 10001"
								 data-disable-controls="true" data-height="230" data-marker-title="StartApp"
								 data-scrollwheel="false" data-zoom="14">
							</div>
						</div>
						...
						<form>
							...
							<div class="row">
								...
								<div class="col-md-3 col-sm-6 padding-bottom-1x">
									<input name="phone" placeholder="Phone Number" size="40" type="text"
										   value=""></span>
								</div>
								...
								<div class="col-md-3 col-sm-6 padding-bottom-1x">
									<button class="btn btn-block btn-transparent btn-primary"
											style="margin-top: 0; outline: none;" type="submit">Send Message <i
