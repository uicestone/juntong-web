					...
					<article>
						...
						<section class="fw-section">
							<div class="container">
								<div class="text-block">
									<h4>
										3&nbsp;Maecenas Lobortis, Lorem At Commodo Tincidunt, Elit Arcu Dictum Erat, Nec
										Pulvinar Mi Augue a Purus
									</h4>

									<p>
										Sed finibus fringilla ante sed semper. Sed sit amet ultricies eros, in interdum
										eros. Suspendisse vitae porta dolor, eget auctor nulla. Phasellus varius velit
										sed ex ultrices, id consequat sem posuere. Quisque non nulla vitae lectus dictum
										rutrum eu id mi. Donec urna neque, viverra eget sapien in, maximus lobortis
										ipsum. Cras pretium nec nisl nec dapibus. Fusce et leo sed dui auctor dignissim
										sit amet at magna. Nam in tincidunt nibh, at hendrerit lorem. Praesent pulvinar
										risus ac velit imperdiet tincidunt. Maecenas lobortis, lorem at commodo
										tincidunt, elit arcu dictum erat, nec pulvinar mi augue a purus. Integer sapien
										justo, laoreet eu posuere quis, sodales nec purus. Proin sollicitudin, eros
										venenatis ullamcorper auctor, ipsum metus dignissim metus, ac commodo ante risus
										at orci. Proin ac libero nec mi dictum tempor. Aliquam vestibulum aliquam risus
										vel finibus. Maecenas aliquet efficitur lorem a bibendum.
									</p>
							...
							<div class="container">
								<div class="text-block">
									...
									<p>
										...
										risus ac velit imperdiet tincidunt. Maecenas lobortis, lorem at commodo
										tincidunt, elit arcu dictum erat, nec pulvinar mi augue a purus. Integer sapien
										justo, laoreet eu posuere quis, sodales nec purus:
									</p>
								</div>
								...
								<div class="text-block">
									...
									<p>
										...
										rutrum eu id mi. Donec urna neque, viverra eget sapien in, maximus lobortis
										ipsum. Cras pretium nec nisl nec dapibus. Fusce et leo sed dui auctor dignissim
										sit amet at magna. Nam in tincidunt nibh, at hendrerit lorem.
									</p>

									<blockquote>
										<p>
											Fusce et leo sed dui auctor dignissim sit amet at magna. Nam in tincidunt
											nibh, at hendrerit lorem. Praesent pulvinar risus ac velit imperdiet
											tincidunt. Maecenas lobortis, lorem at commodo tincidunt, elit arcu dictum
											erat, nec pulvinar mi augue a purus.
										</p>
									</blockquote>
								</div>
							</div>
						...
						<div class="container">
							...
							<div class="post-share-buttons">
								<div class="column">
									<a class="startapp-share-twitter" href="#"><i class="socicon-twitter"></i> Share on
										Twitter</a>
								</div>

								<div class="column">
									<a class="startapp-share-facebook" href="#"><i class="socicon-facebook"></i> Share
										on Facebook</a>
								</div>

								<div class="column">
									<a class="startapp-share-googleplus" href="#"><i class="socicon-googleplus"></i>
										Share on Google+</a>
								</div>

								<div class="column">
									<a class="startapp-share-pinterest" href="#"><i class="socicon-pinterest"></i> Share
										on Pinterest</a>
								</div>
							</div>
