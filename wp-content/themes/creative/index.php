    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>上海君桐股权投资管理有限公司</h1>
                <hr>
                <p>国内资深投资专家和知名投资机构联合创立的、为中国领先的从事私募股权投资和风险投资业务的私募股权投资机构，是最具市场敏锐度的以拟上市企业私募股权为主要投资对象的投资机构之一。</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">值得你的期待</h2>
                    <hr class="light">
                    <p class="text-faded">基于长期根植于中国及海外企业私募股权投资的丰富经验，对中国及海外资本市场的充分了解，以及多年运作私募股权投资基金的良好经历和业绩，我们以自有资本和所管理的私募股权和风险投资基金对中国成长型企业进行股权投资，发现、挖掘及提升企业价值、帮助实现企业的价值最大化；同时也使得所管理的基金投资的机会成本最低化、风险最小化、渠道系统化及服务专业化。</p>
                    <p class="text-faded">君桐凭借专业的投资团队、雄厚的财团LP支持、丰富的资本运作经验以及产业战略投资者联盟，为众多拟在境内上市融资的优秀企业，提供扩张和增长所需的资金,并提供专业的投资管理服务；同时，君桐自身也逐步独创性地摸索出一套以私募股权投资为核心、以特定领域为主导的投资基金管理及企业资本运作和价值发现和挖掘为运营模式的投资项目管理机制。</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">为您服务</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
...
<!--     <aside class="bg-dark">
 ...
 -->    <section id="contact">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">马上联络</h2>
                    <hr class="primary">
                    <p>耳听为虚，眼见为实。</p>
                </div>
                ...
                <div class="col-lg-4 text-center">
                    ...
                    <p><a href="mailto:your-email@your-domain.com">will@jt-capital.cn</a></p>
                </div>
            </div>
        </div>
    </section>
