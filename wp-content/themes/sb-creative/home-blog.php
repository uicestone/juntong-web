...
if($wl_theme_options['home_blog_enabled']=='on'){ ?>
<div id="latest-posts" class=" margin-top100">
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12 text-center">
			<?php if($wl_theme_options['home_blog_title']){ ?>
                <h2 class="wow bounceIn"><?php echo esc_attr($wl_theme_options['home_blog_title']); ?></h2>
            <?php } if($wl_theme_options['home_blog_description']){ ?>
				<h4 class="wow fadeInRight"><?php echo esc_attr($wl_theme_options['home_blog_description']); ?></h4>
            <?php } ?>
			</div>
        </div>
        <div class="row">
