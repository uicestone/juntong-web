            ...
            <div class="portfolio-content">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><?php
                    ...
                    <div class="portfolio-title text-center">
                        <h2 class="wow bounceIn"><?php echo esc_attr($wl_theme_options['home_port_title']); ?></h2>
                        <h4 class="wow fadeInRight"><?php echo esc_attr($wl_theme_options['home_port_description']); ?> </h4>
                    </div>
					<?php } ?>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12 portfolio-three-column wow bounceIn">
                    <div class="grid">
						...
						<figure class="effect-zoe portfolio-border web jquery item">
							...
							<figcaption>
								<h2><?php echo esc_attr($wl_theme_options['port_title_'.$i]); ?><span><?php _e(' ', 'creative'); ?><?php echo esc_attr($wl_theme_options['port_tagline_'.$i]);; ?></span></h2>
								...
								<p><?php echo esc_attr($wl_theme_options['port_description_'.$i]); ?></p>
							</figcaption>
						</figure>
						<?php } ?>
                    </div>
