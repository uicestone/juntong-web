...
<?php if ( is_active_sidebar( 'sidebar-primary' ) )
			...
			<div class="contents">
				...
				<div class="tabscontent" id="content2">
					<ul class="posts">
						...
						<li>
							<a href="#"><img class="img-thumbnail recent-post-img" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/68x68.png"></a>
							<p><a href="#"><?php _e('Lorem Ipsum is simply dummy text.', ''); ?></a></p>
							<span class="color"><?php _e('30 July 2014', 'creative'); ?></span>
						</li>
					</ul>
				</div>
	...
	<div class="widget text">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<p><?php _e('Fugiat dapibus, tellus ac cursus commodo, mauesris condime ntum nibh, ut fermentum mas justo sitters amet risus. Cras mattis cosi sectetut amet fermens etrsaters tum aecenas faucib sadips amets.', ''); ?></p>
			</div>
		</div>
	</div>
	<!-- /Text Widget -->
