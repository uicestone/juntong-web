			...
			<div class="row">
				<div class="slogan-content">
					<div class="col-lg-10 col-md-10 wow fadeInLeft"><?php
						...
						<h2 class="slogan-title"><?php echo esc_attr($wl_theme_options['footer_call_out_title']); ?></h2><?php
						} ?>
					</div>
					<div class="col-lg-2 col-md-2 wow fadeInRight">
					<?php if($wl_theme_options['footer_call_out_button_text']){ ?>
						<div class="get-started">
						<a href='<?php if($wl_theme_options['footer_call_out_button_link']!=""){echo esc_url($wl_theme_options['footer_call_out_button_link']); } ?>' <?php if($wl_theme_options['footer_call_out_button_target']=="on"){ echo "target='_blank'"; } ?> class="btn-special btn-grey pull-right">
