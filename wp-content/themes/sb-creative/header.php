					...
					<div class="slidedown collapse">
						<div class="container">
							...
							<div class="phone-login pull-right">
								...
								<a><i class="fa fa-phone"></i> <?php _e('Call Us : ','creative');  echo esc_attr($wl_theme_options['phone_no']); ?></a>
								<?php } if($wl_theme_options['email_id'] !='') { ?>
								<a><i class="fa fa-envelope"></i><?php _e('Email : ','creative');  echo sanitize_email($wl_theme_options['email_id']); ?></a>
								<?php } ?>
							</div>
							<?php } ?>
						</div>
